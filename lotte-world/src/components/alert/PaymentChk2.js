...
const PaymentChk2 = memo(({ setPaymentChk2 }) => {
  return (
    <Background>
      <PaymentChkContainer>
        <header>
          <h1>개인정보 수집·이용</h1>
          <button onClick={() => setPaymentChk2(false)}>
        ...
        <div className="pop-bottom">
          <button onClick={() => setPaymentChk2(false)}>취소</button>
          <button onClick={() => setPaymentChk2(false)}>확인</button>
        </div>
      </PaymentChkContainer>
    </Background>
  );
