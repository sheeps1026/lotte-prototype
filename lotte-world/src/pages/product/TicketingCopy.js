...
import minusBtn from "../../assets/images/pages/product/btn_minus_on.png";
import plusBtn from "../../assets/images/pages/product/btn_plus_on.png";
          ...
          .btnWrap {
            ...
            button {
              ...
              &:first-child {
                ...
                background: url(${minusBtn}) no-repeat 50% 50%;
              }
              &:last-child {
                border-radius: 0 3px 3px 0;
                background: url(${plusBtn}) no-repeat 50% 50%;
                margin-left: -1px;
              }
            }
          }
                    ...
                    <ul>
                      <li>
                        ...
                        <div className="countWrap">
                          <em className="count" style={{color: colorA}} onChange={setPriceA(numberA * 30000)}>{numberA}</em>
                      ...
                      <li>
                        ...
                        <div className="countWrap">
                          <em className="count" style={{color: colorY}} onChange={setPriceY(numberY * 20000)}>{numberY}</em>
                          <span className="btnWrap">
                      ...
                      <li>
                        ...
                        <div className="countWrap">
                          <em className="count" style={{color: colorC}} onChange={setPriceC(numberC * 10000)}>{numberC}</em>
                          <span className="btnWrap">
                    ...
                    <li>
                      ...
                      <div className="itemCont">
                        ...
                        <div className="finalPrice">
                          ...
                          <div className="price">
                            <span>{priceA+priceY+priceC}</span> 원
                          </div>
                        </div>
