    ...
    (async () => {
      ...
      try {
        const response = await axios.get(
          `https://sheeps1026.github.io/backend/enjoyInfoList.json?EN_id=${EN_id}`
        );
        json = response.data;
      } catch (e) {
        console.error(e);
                      ...
                      <div className="half">
                        ...
                        <div className="info_box">
                          <ul className="info_list">
                            <li>한 달 동안의 운휴정보입니다.</li>
                            <li>
                              기상 변화 및 파크 상황에 따라 운휴 일정이 변경될
                              수 있습니다.
                            </li>
                            <li>
                              기상상태에 따라 일부 어트랙션 운행이 중단될 수
                              있습니다.
                            </li>
                          </ul>
                        </div>
